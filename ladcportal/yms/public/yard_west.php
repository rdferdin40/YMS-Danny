...
$user = getCurrentUser();
$pageTitle = 'West Yard - Penske Laredo YMS';

// Get all trailers in West Yard
$trailers = Trailer::getByYard('WEST_YARD');
...
<div class="container-fluid mt-4">
    <div class="row mb-4">
        <div class="col-md-6">
            <h2>
                <i class="bi bi-grid-3x3"></i> West Yard
                <span class="badge bg-primary"><?php echo count($trailers); ?> Trailers</span>
            </h2>
        </div>
        <div class="col-md-6 text-end">
            <a href="yard_east.php" class="btn btn-outline-success">
                <i class="bi bi-arrow-left-circle"></i> Switch to East Yard
            </a>
        </div>
    </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php if (empty($trailers)): ?>
                            <tr>
                                <td colspan="8" class="text-center text-muted">No trailers in West Yard</td>
                            </tr>
                        <?php else: ?>
