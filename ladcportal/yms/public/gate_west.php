...
$user = getCurrentUser();
$pageTitle = 'West Gate - Penske Laredo YMS';
$gate = 'West'; // Enforce West gate
            ...
            if ($existingTrailer && !isset($_POST['confirm_duplicate'])) {
                ...
                try {
                    $trailerId = Trailer::create([
                        ...
                        'gate' => $gate,
                        'yard_area' => 'WEST_YARD', // Default to West Yard for West gate
                    ...
                    Move::create([
                        ...
                        'to_yard_area' => 'WEST_YARD',
                        'move_type' => 'CHECK_IN',
                        'performed_by_user_id' => $user['id'],
                        'notes' => 'Check-in at West Gate'
                    ]);
                    ...
                    redirect('gate_west.php?action=checkin', 'Trailer ' . $trailerNumber . ' checked in successfully at West Gate', 'success');
                } catch (Exception $e) {
        ...
        if (empty($trailerNumber)) {
            ...
            if (!$trailer) {
                ...
                try {
                    ...
                    redirect('gate_west.php?action=checkout', 'Trailer ' . $trailerNumber . ' checked out successfully from West Gate', 'success');
                } catch (Exception $e) {
...
<div class="container-fluid mt-4">
    <div class="row mb-4">
        <div class="col-12">
            <h2>
                <i class="bi bi-shield-check"></i> West Gate Check-In/Out
                <span class="badge bg-primary">WEST</span>
            </h2>
        </div>
    </div>
    ...
    <?php if ($duplicateWarning): ?>
        <div class="alert alert-warning">
            ...
            <form method="POST">
                ...
                <a href="gate_west.php" class="btn btn-secondary">Cancel</a>
            </form>
        </div>
    <?php endif; ?>
    ...
    <ul class="nav nav-tabs mb-3" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link <?php echo $action === 'checkin' ? 'active' : ''; ?>"
                    onclick="window.location.href='gate_west.php?action=checkin'">
                <i class="bi bi-box-arrow-in-right"></i> Check-In
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link <?php echo $action === 'checkout' ? 'active' : ''; ?>"
                    onclick="window.location.href='gate_west.php?action=checkout'">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header bg-info text-white">
                    <h6 class="mb-0"><i class="bi bi-clock-history"></i> Recent West Gate Activity</h6>
                </div>
